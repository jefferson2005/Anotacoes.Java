...
public class SistemaSA extends JFrame {
	...
	public SistemaSA() {
		...
		JLabel lblExcluir = new JLabel("Excluir Chamado");
		...
		lblAtualizar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Os campos Responsável Chamado, Id do Chamado, Status do Chamado e Data de Resolução devem ser preenchidos","Erro 4000765x" , 
				...
				cr.setObservacoes(lblObservacoes.getText()); 
				cr.setIdChamado(Long.parseLong(txtID.getText())); 
				cc.atualizar(cr);
		...
		txtObservacoes.setBounds(183, 209, 325, 117);
